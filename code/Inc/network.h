...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "eiecg_contest_finalnnclassifiertensorflowlitefloat32model"
...
#define AI_NETWORK_IN_1_CHANNEL     (67)
#define AI_NETWORK_IN_1_SIZE        (67)
#define AI_NETWORK_IN_1_SIZE_BYTES  (268)
