...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 668, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (668)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (668)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 16620, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (16620)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (16620)
